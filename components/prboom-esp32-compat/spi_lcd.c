...
static const ili_init_cmd_t ili_init_cmds[]={
    ...
    {0xC0, {0x26}, 1},               // Power control 1 (VRH voltage)
    {0xC1, {0x11}, 1},               // Power control 2 (SAP/BT)
    {0xC5, {0x35, 0x3E}, 2},         // VCOM control 1
    {0xC7, {0xBE}, 1},               // VCOM control 2
    {0x36, {0x68}, 1},               // MADCTL (Memory Access Control: rotation/mirror)
    {0x3A, {0x55}, 1},               // COLMOD: Pixel format (0x55 = RGB565 16-bit)
    {0xB1, {0x00, 0x1B}, 2},         // Frame rate control
    {0xF2, {0x08}, 1},               // Enable 3G (Gamma control enable)
    {0x26, {0x01}, 1},               // Gamma curve select
    {0xE0, {0x1F, 0x1A, 0x18, 0x0A, 0x0F, 0x06, 0x45, 0x87, 0x32, 0x0A, 0x07, 0x02, 0x07, 0x05, 0x00}, 15}, // Positive gamma correction
    {0xE1, {0x00, 0x25, 0x27, 0x05, 0x10, 0x09, 0x3A, 0x78, 0x4D, 0x05, 0x18, 0x0D, 0x38, 0x3A, 0x1F}, 15}, // Negative gamma correction

    {0x2A, {0x00, 0x00, 0x00, 0xEF}, 4}, // CASET: Column address set (0–239)
    {0x2B, {0x00, 0x00, 0x00, 0xEF}, 4}, // RASET: Row address set (0–239)

    {0x2C, {0}, 0},                  // RAMWR: Memory write (start GRAM write)
    {0xB7, {0x07}, 1},               // Entry mode set
    {0xB6, {0x0A, 0x82, 0x27, 0x00}, 4}, // Display function control
    {0x11, {0}, 0x80},               // SLPOUT: Exit sleep mode (delay 120ms)
    {0x29, {0}, 0x80},               // DISPON: Display ON (delay 120ms)
    {0, {0}, 0xff},
};
...
static const ili_init_cmd_t ili_init_cmds[]={
    ...
    {0x2A, {0x00, 0x00, 0x00, 0xEF}, 4},// CASET: column 0-239
    {0x2B, {0x00, 0x00, 0x01, 0x3f}, 4}, // RASET: row 0-319
    {0x2C, {0}, 0},
    {0xB7, {0x07}, 1},
